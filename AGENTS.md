...
**Migrating HelmChart CRs into a plain Helm release (verified mechanics; not currently used)** — if the task-based kustomize pipeline is ever replaced by an umbrella Helm chart, the cutover can be zero-uninstall:
