...
```
task <target>:validate                          # YAML + kustomize + compose config checks
...
task <target>:k3s:group:base|apps:apply|delete
task <target>:k3s:deploy -- <component> [apply|delete|diff|yaml]
